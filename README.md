...
2. [List OSes support](#list-oses-support)
...
- For **Linux** & **BSD** variants:
  ...
  - `sysstat` _(`mpstat` command)_, `procps` _(`free` command)_: For [CPU & Memory usage info](#list-oses-support).
  - `iw`: For [Network's SSID](#list-oses-support).
  - `ip`: For [Network's IPv4 address](#list-oses-support).
  - `acpi`: For [Battery info](#list-oses-support).
...
- For **Mac**:
  ...
  - `ip`: For [Network's IPv4 address](#list-oses-support).
  - `pmset`: For [Battery info](#list-oses-support).
...
- [**Nerd Font** version 3.0.0+](https://github.com/ryanoasis/nerd-fonts) (mine is [**_JetBrainsMono Nerd Font_**](https://github.com/ryanoasis/nerd-fonts/tree/master/patched-fonts/FiraCode)).
...
| **Option name**                           | **Description**                                                     | **Default value** |
| ----------------------------------------- | ------------------------------------------------------------------- | :---------------: |
| `@ultimate-theme-show-powerline`          | Choose to show [Powerline symbols](#list-oses-support) or not       |      `true`       |
| `@ultimate-theme-show-prefix`             | Choose to show [Prefix](#list-oses-support) or not                  |      `true`       |
| `@ultimate-theme-show-cpu-mem`            | Choose to show [CPU & Memory usage info](#list-oses-support) or not |      `true`       |
| `@ultimate-theme-show-date-time`          | Choose to show [Date & Time](#list-oses-support) or not             |      `true`       |
| `@ultimate-theme-show-network-ip-address` | Choose to show [Network's IPv4 address](#list-oses-support) or not  |      `true`       |
| `@ultimate-theme-show-network-id`         | Choose to show [Network's SSID](#list-oses-support) or not          |      `true`       |
| `@ultimate-theme-show-battery`            | Choose to show [Battery info](#list-oses-support) or not            |      `true`       |
...
| `@ultimate-theme-icon-network-offline`       | Set icon of **Network** when in **_Offline_** mode                                         | `󰅛` or `\uDB80\uDD5B` |
| `@ultimate-theme-icon-network-ethernet`      | Set icon of **Network** when in **_Ethernet_** mode                                        | `󰛳` or `\uDB81\uDEF3` |
